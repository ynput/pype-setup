...
def test_format_anatomy(valid_templates, valid_data):

    anatomy = Anatomy()
    formatted_with_optional = anatomy.format(valid_templates, valid_data)
    formatted_no_optional = anatomy.format(template, test_data_2)
