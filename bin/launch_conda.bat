...
set PATH=%PYTHON_ENV%;%PYTHON_ENV%\Scripts;%PYTHON_ENV%\Library;%PYTHON_ENV%\Library\bin
set PYTHONPATH=%PYTHONPATH%;%PYTHON_ENV%\Lib\site-packages;%PYPE_SETUP_ROOT%
set GIT_PYTHON_GIT_EXECUTABLE=%PYTHON_ENV%\Library\bin\git.exe
